...
# - F-C-C-F and C-C-C-F
# - F-C-C-F and F-C-C-C
# - Why are F-C-C-C and C-C-C-F torsions 2 different things and only correlate with each other 0.8?
...
# - C-C-O-C and C-O-C-C
# - C-O-C-C and F-C-O-C
# --> These 3 just correlate to each other --> Randomly drop 2 of them.
# - H-C-C-O and H-C-C-C
# --> Randomly drop one.
# Low correlation with all targets (<= 0.1): 14 descriptors
# H-O-C-C, O-C-C-C, O-C-C-F, F-C-C-O, C-C-O-H, O-C-C-H, C-C-O-O, C-C-C-H, H-C-O-H, C-C-O-C, F-C-O-C, C-O-C-H, C-O-C-F, C-O-C-C, H-C-C-F, O-C-C-O, C-O-C-O, O-C-O-C
...
all_summaries = all_summaries.round(3)
display(all_summaries)
